...
public final class Utils {
    ...
    private static final String PERMISSION_ACTIVITY_CLASS_NAME = "com.hunter.utils.PermissionUtils$PermissionActivity";
    ...
    /**
     * Gets activity lifecycle.
     *
     * @return the activity lifecycle
     */
    ...
    /**
     * Gets top activity or app.
     *
     * @return the top activity or app
     */
    ...
    static class ActivityLifecycleImpl implements ActivityLifecycleCallbacks {
        ...
        /**
         * Add on app status changed listener.
         *
        ...
        /**
         * Remove on app status changed listener.
         *
         * @param object the object
         */
        ...
        /**
         * Remove on activity destroyed listener.
         *
        ...
        /**
         * Add on activity destroyed listener.
         *
         * @param activity the activity
         * @param listener the listener
         */
        ...
        private void consumeOnActivityDestroyedListener(Activity activity) {
            Iterator<Map.Entry<Activity, Set<OnActivityDestroyedListener>>> iterator = mDestroyedListenerMap.entrySet().iterator();
    ...
    /**
     * The type File provider 4 util code.
     */
    ...
    /**
     * The interface On app status changed listener.
     */
    ...
    /**
     * The interface On activity destroyed listener.
     */
