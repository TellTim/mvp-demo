...
/**
 * The type Snackbar utils.
 */
public final class SnackbarUtils {

  /**
   * The constant LENGTH_INDEFINITE.
   */
  ...
  /**
   * The constant LENGTH_LONG.
   */
  public static final int LENGTH_LONG = 0;

  /**
   * The interface Duration.
   */
   ...
   * Set the duration.
   *
   * @param duration The duration.                 <ul>                 <li>{@link Duration#LENGTH_INDEFINITE}</li>                 <li>{@link Duration#LENGTH_SHORT     }</li>                 <li>{@link Duration#LENGTH_LONG      }</li>                 </ul>
   * @return the single {@link SnackbarUtils} instance
   */
