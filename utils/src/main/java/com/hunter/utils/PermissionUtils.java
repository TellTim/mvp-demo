...
import com.hunter.utils.constant.PermissionConstants;
...
public final class PermissionUtils {
  ...
  public static boolean isGranted(final String... permissions) {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M || PackageManager.PERMISSION_GRANTED == ContextCompat.checkSelfPermission(Utils.getApp(), permission);
    }
  ...
  public interface FullCallback {
     ...
     * On granted.
     *
     * @param permissionsGranted the permissions granted
     */
     ...
     * On denied.
     *
     * @param permissionsDeniedForever the permissions denied forever
     * @param permissionsDenied the permissions denied
     */
