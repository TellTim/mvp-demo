...
public final class SpanUtils {
   ...
   *
   * @param flag The flag.             <ul>             <li>{@link Spanned#SPAN_INCLUSIVE_EXCLUSIVE}</li>             <li>{@link Spanned#SPAN_INCLUSIVE_INCLUSIVE}</li>             <li>{@link Spanned#SPAN_EXCLUSIVE_EXCLUSIVE}</li>             <li>{@link Spanned#SPAN_EXCLUSIVE_INCLUSIVE}</li>             </ul>
   ...
   *
   * @param lineHeight The line height, in pixel.
   * @param align The alignment.                   <ul>                   <li>{@link Align#ALIGN_TOP   }</li>                   <li>{@link Align#ALIGN_CENTER}</li>                   <li>{@link Align#ALIGN_BOTTOM}</li>                   </ul>
   * @return the single {@link SpanUtils} instance
   */
   ...
   *
   * @param fontFamily The font family.                   <ul>                   <li>monospace</li>                   <li>serif</li>                   <li>sans-serif</li>                   </ul>
   * @return the single {@link SpanUtils} instance
   */
   ...
   *
   * @param alignment The alignment.                  <ul>                  <li>{@link Alignment#ALIGN_NORMAL  }</li>                  <li>{@link Alignment#ALIGN_OPPOSITE}</li>                  <li>{@link Alignment#ALIGN_CENTER  }</li>                  </ul>
   * @return the single {@link SpanUtils} instance
   */
   ...
   *
   * @param align The alignment.              <ul>              <li>{@link Align#ALIGN_TOP     }</li>              <li>{@link Align#ALIGN_CENTER  }</li>              <li>{@link Align#ALIGN_BASELINE}</li>              <li>{@link Align#ALIGN_BOTTOM  }</li>              </ul>
   * @return the single {@link SpanUtils} instance
   */
   ...
   * @param style The style.               <ul>               <li>{@link Blur#NORMAL}</li>               <li>{@link Blur#SOLID}</li>               <li>{@link Blur#OUTER}</li>               <li>{@link Blur#INNER}</li>               </ul>
   * @return the single {@link SpanUtils} instance
   */
  ...
  static class VerticalAlignSpan extends ReplacementSpan {
    ...
    /**
     * The M vertical alignment.
     */
    final int mVerticalAlignment;

    /**
     * Instantiates a new Vertical align span.
     *
  ...
  /**
   * The type Custom line height span.
   */
  static class CustomLineHeightSpan implements LineHeightSpan {
    ...
    /**
     * Instantiates a new Custom line height span.
     *
  ...
  static class SpaceSpan extends ReplacementSpan {
        ...
        @Override
        public int getSize(@NonNull final Paint paint, final CharSequence text, @IntRange(from = 0) final int start, @IntRange(from = 0) final int end, @Nullable final Paint.FontMetricsInt fm) {
            return width;
        }

        @Override
        public void draw(@NonNull final Canvas canvas, final CharSequence text, @IntRange(from = 0) final int start, @IntRange(from = 0) final int end, final float x, final int top, final int y, final int bottom, @NonNull final Paint paint) {
  ...
  /**
   * The type Custom dynamic drawable span.
   */
