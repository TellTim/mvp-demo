...
import com.hunter.utils.constant.RegexConstants;
...
public final class RegexUtils {
   ...
   * @return the string constructed by replacing the first matching subsequence by the replacement string, substituting captured subsequences as needed
   */
