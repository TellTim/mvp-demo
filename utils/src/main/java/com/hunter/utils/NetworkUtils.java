...
public final class NetworkUtils {
  ...
  public enum NetworkType {
    /**
     * Network ethernet network type.
     */
    NETWORK_ETHERNET, /**
     * Network wifi network type.
     */
    NETWORK_WIFI, /**
     * Network 4 g network type.
     */
    NETWORK_4G, /**
     * Network 3 g network type.
     */
    NETWORK_3G, /**
     * Network 2 g network type.
     */
    NETWORK_2G, /**
     * Network unknown network type.
     */
    NETWORK_UNKNOWN, /**
     * Network no network type.
     */
    NETWORK_NO
    }
   ...
   * {@code <uses-permission android:name="android.permission.ACCESS_NETWORK_STATE" />}</p>
   *
   * @return type of network <ul> <li>{@link NetworkType#NETWORK_ETHERNET} </li> <li>{@link NetworkType#NETWORK_WIFI    } </li> <li>{@link NetworkType#NETWORK_4G      } </li> <li>{@link NetworkType#NETWORK_3G      } </li> <li>{@link NetworkType#NETWORK_2G      } </li> <li>{@link NetworkType#NETWORK_UNKNOWN } </li> <li>{@link NetworkType#NETWORK_NO      } </li> </ul>
   */
  @RequiresPermission(ACCESS_NETWORK_STATE)
  ...
  @RequiresPermission(ACCESS_WIFI_STATE)
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak") WifiManager wm = (WifiManager) Utils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) {
          return "";
        }
