...
public final class ToastUtils {
  ...
  static class SystemToast extends AbsToast {
    ...
    /**
     * Instantiates a new System toast.
     *
    ...
    static class SafeHandler extends Handler {
      ...
      /**
       * Instantiates a new Safe handler.
       *
       * @param impl the
       */
  ...
  static class ToastWithoutNotification extends AbsToast {
        ...
        private Utils.OnActivityDestroyedListener listener = new Utils.OnActivityDestroyedListener() {
            @Override
    ...
    /**
     * Instantiates a new Toast without notification.
     *
     * @param toast the toast
     */
