...
public final class PhoneUtils {
   ...
   *
   * @return the current phone type <ul> <li>{@link TelephonyManager#PHONE_TYPE_NONE}</li> <li>{@link TelephonyManager#PHONE_TYPE_GSM }</li> <li>{@link TelephonyManager#PHONE_TYPE_CDMA}</li> <li>{@link TelephonyManager#PHONE_TYPE_SIP }</li> </ul>
   */
   ...
   * {@code <uses-permission android:name="android.permission.READ_PHONE_STATE" />}</p>
   *
   * @return DeviceId = 99000311726612<br> DeviceSoftwareVersion = 00<br> Line1Number =<br> NetworkCountryIso = cn<br> NetworkOperator = 46003<br> NetworkOperatorName = 中国电信<br> NetworkType = 6<br> PhoneType = 2<br> SimCountryIso = cn<br> SimOperator = 46003<br> SimOperatorName = 中国电信<br> SimSerialNumber = 89860315045710604022<br> SimState = 5<br> SubscriberId(IMSI) = 460030419724900<br> VoiceMailNumber = *86<br>
   */
  @SuppressLint("HardwareIds")
    @RequiresPermission(READ_PHONE_STATE)
