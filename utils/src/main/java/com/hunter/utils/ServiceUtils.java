...
public final class ServiceUtils {
   ...
   * @param flags Operation options for the binding.                  <ul>                  <li>0</li>                  <li>{@link Context#BIND_AUTO_CREATE}</li>                  <li>{@link Context#BIND_DEBUG_UNBIND}</li>                  <li>{@link Context#BIND_NOT_FOREGROUND}</li>                  <li>{@link Context#BIND_ABOVE_CLIENT}</li>                  <li>{@link Context#BIND_ALLOW_OOM_MANAGEMENT}</li>                  <li>{@link Context#BIND_WAIVE_PRIORITY}</li>                  </ul>
   */
